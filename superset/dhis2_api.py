    ...
    def execute(  # pylint: disable=unused-argument
        ...
        **kwargs: Any,
        ...
        if analytics_dim is not None:
            response = cls.session.get(f"{ analytics_url }/{opts.get('database','')}/api/analytics/rawData.json?dimension:{analytics_dim}&dimension=ou:USER_ORGUNIT&dimension=pe:LAST_12_MONTHS&outputIdScheme=NAME&outputOrgUnitIdScheme=NAME")
